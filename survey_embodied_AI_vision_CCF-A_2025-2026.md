...
| **复现可行性** | ⭐ 低难度 — 代码开源，HuggingFace 模型可直接下载 |
...
| **复现可行性** | ✅ 高 — 代码开源，AGD20K/CAD120 数据集公开 |
...
| # | 论文 | 会议 | 年份 | 方向 |
|---|------|------|------|------|
| 1 | OpenVLA | NeurIPS | 2024→2025 | VLA 端到端 |
| 2 | π₀ / π₀.₅ | arXiv | 2024–2025 | VLA + Flow Matching |
| 3 | GR-2 | ICML | 2025 | 视频生成 + VLA |
| 4 | TinyVLA | ICML | 2025 | 轻量 VLA |
| 5 | RoboVLA | arXiv | 2025 | 联合训练 VLA |
| 6 | RoboFlamingo | CVPR | 2025 | VLM → VLA |
| 7 | 3D Diffusion Policy (DP3) | CVPR | 2025 | 3D 扩散策略 |
| 8 | ManiCM | CVPR | 2025 | 实时扩散策略 |
| 9 | UMI | CVPR | 2025 | 数据采集接口 |
| 10 | Clio | CVPR | 2025 | 实时 3D 场景图 |
| 11 | SpatialVLM | CVPR | 2025 | VLM 空间推理 |
| 12 | AffordanceSAM | CVPR WS | 2025 | 供用性分割 |
| 13 | AnyGrasp | ICML | 2024→2025 | 通用抓取 |
| 14 | GaussianGrasper | CVPR | 2024→2025 | 3DGS 抓取 |
| 15 | PhysDreamer | NeurIPS | 2024→2025 | 物理属性估计 |
| 16 | PhysBench | NeurIPS | 2024→2025 | 物理属性基准 |
| 17 | HOMER | NeurIPS | 2024 | 家用物体属性库 |
| 18 | ConceptGraphs | ICRA→2025 | 3D 场景图 | |
| 19 | VoxPoser | CoRL→2025 | LLM + 3D 价值图 | |
| 20 | DexVLG | NeurIPS | 2024→2025 | 语言引导灵巧抓取 |
